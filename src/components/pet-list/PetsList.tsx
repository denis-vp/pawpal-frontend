...
const PetsList: React.FC<PetsListProps> = ({ pets }) => {
    ...
    const handleAddPet = (id: number, name: string, gender: string, age: string, breed: string, weight: string, image: string) => {
    ...
    return (
        <ThemeProvider theme={theme}>
            <Box sx={{ padding: 4, marginTop: '100px', textAlign: 'center', width: '100%' }}>
                <Typography variant="h1" sx={{ textAlign: 'center' }}>All Pets Page</Typography>
